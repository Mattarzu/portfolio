const SOURCES = [
  ...
  },
  {
    id: "mollchef",
    title: "MollChef",
    href: "https://mollchef.56-126-148-93.sslip.io/",
    keywords: [
      "mollchef",
      "cocina",
      "cooking",
    ...
    es:
      "MollChef es una PWA de cocina mobile-first desplegada en producción. Integra escaneo multimodal de recetas, el asistente contextual Cleo, edición protegida, timers y un Cooking Mode guiado con sesiones persistentes. Su stack full stack usa React/TypeScript, Node, PostgreSQL, Docker, Caddy y AWS Lightsail, con CI/CD y healthchecks.",
    en:
      "MollChef is a production mobile-first cooking PWA. It combines multimodal recipe scanning, the contextual Cleo assistant, protected editing, timers and a guided Cooking Mode with persistent sessions. Its full-stack system uses React/TypeScript, Node, PostgreSQL, Docker, Caddy and AWS Lightsail, with CI/CD and health checks.",
  },
  {
    id: "motoratlas",
    title: "MotorAtlas 3D",
    href: "https://allfiction.56-126-148-93.sslip.io/#ingenieria-reciente",
    keywords: [
      "motoratlas",
      "automotor",
      "automotive",
    ...
    es:
      "MotorAtlas 3D es un MVP mobile-first de diagnóstico automotor nacido de un caso mecánico real. Modela sistemas y componentes en PostgreSQL/MinIO y ofrece exploración 2D/3D, procedimientos pausables y armado inverso. El MVP verificado contiene 11 componentes, 16 pasos guiados y 5 de 5 pruebas E2E; Three.js se carga de forma diferida para proteger el camino crítico.",
    en:
      "MotorAtlas 3D is a mobile-first automotive diagnostics MVP based on a real mechanical case. It models systems and components in PostgreSQL/MinIO and offers 2D/3D exploration, pausable procedures and reverse assembly. The verified MVP contains 11 components, 16 guided steps and 5/5 E2E tests; Three.js is lazy-loaded to protect the critical path.",
  },
  {
    id: "mattmesh",
    title: "MattMesh / AgentBridge",
    href: "https://allfiction.56-126-148-93.sslip.io/#ingenieria-reciente",
    keywords: [
      "mattmesh",
      "agentbridge",
    ...
    es:
      "MattMesh y AgentBridge forman una infraestructura distribuida de tres nodos para desarrollo remoto, automatización por agentes y cargas de IA. Integra Tailscale, OpenSSH, Wake-on-LAN, PostgreSQL, Redis, n8n, Hermes, Telegram y voz local acelerada por GPU. Whisper procesa como referencia 11 segundos de audio en aproximadamente 0,57 segundos sobre una RTX 3080 Ti.",
    en:
      "MattMesh and AgentBridge form a three-node distributed infrastructure for remote development, agent automation and AI workloads. It combines Tailscale, OpenSSH, Wake-on-LAN, PostgreSQL, Redis, n8n, Hermes, Telegram and GPU-accelerated local voice. As an observed reference, Whisper processes 11 seconds of audio in about 0.57 seconds on an RTX 3080 Ti.",
  },
  {
    id: "crypto-risk",
